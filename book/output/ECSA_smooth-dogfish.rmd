...
### Strata definition
```{r strata-map, eval = TRUE, echo = FALSE, fig.cap= "Strata map for smooth dogfish (*Mustelus canis*) on the NE shelf", message = FALSE, warning = FALSE, fig.align='center'}
