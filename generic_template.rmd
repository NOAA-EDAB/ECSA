...
Food habits collected aboard NEFSC bottom trawl surveys in the {{COMMON_NAME}} seasonal survey strata were used to estimate weighted diet composition over time (see methods), as well as length composition of sampled fish and sample size. Depending on sample size (number of survey tows and stomachs) seasonal/annual estimates of diet composition or temporally aggregated estimates (5 or 10 year blocks) can be reported. {{COMMON_NAME}} have been collected as a "secondary" priority species from 1977-1980 and from 1985-present (Smith and Link, 2010). 
