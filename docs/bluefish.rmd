...
if (grepl("north", stock_name)){
  map_lab <- paste0('Strata map for the northern component of the bluefish (', ifelse(knitr::is_latex_output(), '\\textit{Pomatomus saltatrix}','*Pomatomus saltatrix*'),') stock on the NE shelf.')
} else if (grepl("south", stock_name)){
  map_lab <- paste0('Strata map for the southern component of the bluefish (', ifelse(knitr::is_latex_output(), '\\textit{Pomatomus saltatrix}','*Pomatomus saltatrix*'),') stock on the NE shelf.')
} else {
  map_lab <- "Strata map for the bluefish (Pomatomus saltatrix) stock on the NE shelf."
}
