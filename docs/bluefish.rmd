...
This report provides contextual ecosystem information for bluefish (*Pomatomus saltatrix*) on the Northeast U.S. Continental Shelf. Data extractions for spring and fall are confined to the bluefish stock area based on respective survey strata sets. The information is intended to span a range of potential factors affecting the productivity and distribution of bluefish, including: surface and bottom temperature and salinity, chlorophyll concentration, indices of habitat, diet composition, and abundance of key zooplankton prey of larval bluefish. These factors can be used to qualitatively inform the interpretation of population status and/or quantitatively to improve model responsiveness to ecosystem factors. The range and complexity of ecosystem data makes it unlikely to find the most relevant and comprehensive factor variables with a first evaluation; this process will require an iterative approach of evaluation and feedback. Additional indices can be included to address the needs of the working group.


### Summary {-#summary}


Bluefish biomass, while relatively stable between the years 1994 and 2007, experienced a strong decline from 2011 through to the present. This decline in biomass proximally coincides with a decrease in occupancy probability, a decrease in the total ecosystem and stock areas available to the fish, as well as an increase in both salinity and temperature within the stock area, and a reduction in both primary and secondary production within the stock area. There is strong evidence for the influence both physical and biological factors affecting the distribution and biomass of bluefish.


The long term trend of dominance by smaller-bodied copepods over larger-bodied copepods may impact bluefish larval recruitment and survival rates of juvenile bluefish. Additionally, there are likely to be ramifications on energy flow through the planktivorous prey of both juvenile and adult bluefish, that can manifest as a delayed response in the biomass of large piscivorous fish like bluefish.


### Stock area {-#stock-area}

```{r strata-map, eval = T, echo = FALSE, fig.cap= "Strata map for bluefish (*Pomatomus saltatrix*) on the NE shelf", message = FALSE, warning = FALSE, fig.align='center'}
...
An optimal interpolation procedure was used to estimate NE Shelf surface and bottom temperatures for two seasonal time frames (see [methods](#methodstempsalin)). The temperature estimates were standardized to April 3 and October 11 for spring and fall over the period 1968-2018. Surface and bottom temperature within the bluefish stock areas are shown below.


## Bottom Temperature {-#bottom-temperature}


Bottom temperature in fall for the coastal areas demarcated by the bluefish strata shows a strong linear increase over time, with a mean annual increase of 0.054 degrees (confidence intervals of 0.032 and 0.076). However, there is also evidence to support more punctuated temperature increases both early and late in the time series with a protracted period of stable temperature in between. There is evidence of step changes in bottom temperatures, which occurred in 1973 and 2013.
...
Fall surface temperature also shows a linear increase over time, albeit slightly lower than that for the bottom temperature, with a mean annual increase of 0.023 degrees (confidence intervals of 0.009 and 0.036). However, there is a stronger case for a punctuated temperature increase late in the time series with a protracted period of stable temperature prior to a step change occurring in 2014. This step change coincides with an increase in mean temperature of ~ 1.5 degrees over a two year period and a nearly 3-degree change in year-over-year fall temperature between 2013 and 2017.
...
An optimal interpolation procedure was used to estimate NE Shelf surface and bottom salinity for two seasonal time frames (see [methods](#methodstempsalin)). Though collected with temperature data, reliable instrumentation limits this time series to 1992-2018. The salinity estimates were standardized to April 3 and October 11 for spring and fall. Surface and bottom salinities within the bluefish stock areas are shown below.


## Bottom Salinity {-#bottom-salinity}


There is no significant linear trend in bottom salinity over the time series, however there is support for a step change increase in salinity occurring in 2012. There also appears to be a ~4-5 year periodicity in bottom salinity in this coastal region, with periods of higher salinity occurring prior to 1995, and between 1999-2003, and 2012-2017.
...
Similar to bottom salinity, there is no significant linear trend in surface salinity over the time series, however there is support for a step change increase in salinity occurring in 2011. There also appears to be a ~4-5 year periodicity in surface salinity in this coastal region, with periods of higher salinity occurring prior to 1996, and between 1999-2003, and 2012-2017.
...
Fall chlorophyll concentrations were relatively stable over the time series with the maximal concentration occurring in the fall of 2011. This was followed by a strong decrease in overall chlorophyll concentrations through the end of the time series. A regime shift analysis on the data suggests a step change occurred in 2015, with a decrease in mean chlorophyll concentration of ~ 0.5 mg m^3^, representing an approximately 20% reduction in mean chlorophyll concentration.


## Chlorophyll concentration in the stock area {-#chlorophyll-concentration-in-the-stock-area}


The concentration of chlorophyll was measured with a suite of satellite sensors and merged into a single dataset (see [methods](#methodschl)). Chlorophyll concentrations in the spring and fall bluefish stock areas are shown below.
...
Bluefish larvae consume copepods during their offshore life history phase. They undergo an ontogenetic shift in diet when they grow to approximately 30-40mm in length and continue to prey on fish as they transition to estuarine nurseries (@marks1993ontogenetic). *Acartia* spp., a dominant coastal copepod genus, exhibited lower abundance in fall during in the mid 1990's but has since recovered. *Calanus finmarchicus*, which is at the southernmost end of its range in this region and has typically low abundance in inshore waters, exhibits large interannual variability driven primarily by cross-shelf transport in this region. Its abundance in the fall in 2018 is presently at time series minima. *Oithona* spp., a very small but numerically important copepod genus exhibits a general increase in abundance throughout the time series in this nearshore region. *Centropages typicus* abundance was high during the 1990's, followed by a lower abundance in the early 2000's, a resurgence in the 2010's followed by the lowest value in the time series in 2017, and *Centropages hamatus* exhibits a similar pattern in abundance. A trend of dominance by smaller bodied copepods such as *Oithona* and *Acartia* over larger-bodied copepods such as *Centropages* spp. May have ramifications on energy flow through prey items that key in on zooplankton such as silversides and anchovies, and there may be a delayed response in the biomass of large predatory piscivores like bluefish following such changes at the base of the food web. Additionally, larval bluefish rely on larger-bodied copods early in their life-history, and an over abundance of less energy-rich smaller copepods may impact recruitment and survival rates.
...
The abundance of other zooplankton in the fall generally increased over the time series, with appendicularians, chaetognaths, gastropods, and hyperiid amphipods showing a strong increase in abundance. However, because the stock area for bluefish is relatively small and coastal, there is large variability for many of these taxa. While adult bluefish are not likely to target may of these taxa as food items, they may be important for other organisms such as anchovies and silversides that are targeted as prey by bluefish and thus may be secondarily important in determining habitat availability.
...
The probability of occurrence was estimated using random forest classification models (see [methods](#methodsocc)). The mean annual probabilities were extracted for the spring and fall stock definition areas. These data provide an estimate of the potential use of the habitat associated with the stock definition. Fall occupancy was relatively stable from 1970-1987, and then cycled on an approximately decadal scale with lower occupancy (~ 45%)  in the 1990’s followed by higher occupancy in the 2000’s which peaked in 2011 prior to decreasing again to the present value of ~ 55% in 2018.
...
The stock area available to bluefish cycled from a period of higher availability early in the time series from 1975 through 1987, followed by lower availability in the 1990’s when approximately half of the previous stock are was available. The area increased again between 2001-2011, afterwhich the available area declined sharply. Current stock area remains at middling levels compared to the overall time series.
...
Bluefish biomass, while relatively stable between the years 1994 and 2007, experienced a strong increase in 2009-2010, which preceded an equally strong but longer-term decline from 2011 through to the present (note that data from 2017 are not included here). This decline in biomass beginning in 2011 aligns with a decrease in occupancy probability, a decrease in the total ecosystem and stock areas available to the fish, as well as an increase in both salinity and temperature, and a reduction in both primary and secondary production within the stock area.
