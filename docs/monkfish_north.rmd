...
title: |
  ...
  | Northern component of the monkfish stock
author: ''
...
if (grepl("north", stock_name)){
  map_lab <- paste0('Strata map for the northern component of the monkfish (', ifelse(knitr::is_latex_output(), '\\textit{Lophius americanus}','*Lophius americanus*'),') stock on the NE shelf.')
} else if (grepl("south", stock_name)){
  map_lab <- paste0('Strata map for the southern component of the monkfish (', ifelse(knitr::is_latex_output(), '\\textit{Lophius americanus}','*Lophius americanus*'),') stock on the NE shelf.')
} else {
  map_lab <- "Strata map for the monkfish (Lophius americanus) stock on the NE shelf."
}
