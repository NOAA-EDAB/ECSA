...
title: |
  ...
  | Northern component of monkfish stock
author: ''
...
This report provides contextual ecosystem information for north monkfish (*Lophius americanus*) on the Northeast U.S. Continental Shelf. Data extractions for spring and fall are confined to the monkfish stock area based on respective survey strata sets. The information is intended to span a range of potential factors affecting the productivity and distribution of monkfish, including: surface and bottom temperature and salinity, chlorophyll concentration, indices of habitat, diet composition, and abundance of key zooplankton prey of larval monkfish. These factors can be used to qualitatively inform the interpretation of population status and/or quantitatively to improve model responsiveness to ecosystem factors. The range and complexity of ecosystem data makes it unlikely to find the most relevant and comprehensive factor variables with a first evaluation; this process will require an iterative approach of evaluation and feedback. Additional indices can be included to address the needs of the working group.


### Summary {-#summary}


The thermal environment for the northern and southern stock components of monkfish has changed significantly during the past fifty years and has undergone more punctuated change in the most recent decade. Temperature has increased during both spring and fall seasons, albeit, more so in the fall. There is also ample evidence that salinity has shifted to higher PSU in both stock areas and during both seasonal periods. The shorter time series for chlorophyll concentration suggests phytoplankton biomass was relatively constant over most of the period of 1998 to 2011 and has been at depressed levels in the most recent six years or so. With the early life history stages of monkfish dependent upon a range of zooplankton taxa, recent shifts in the abundance of key copepod species warrants further investigation. Habitat models for monkfish suggests that occupancy habitat for monkfish has expanded during both spring and fall; the composite area of occupancy habitat within the stock definition areas is only slightly smaller than the habitat in the NE Shelf ecosystem as a whole, suggesting the stock area adequately represents the habitat. The habitat informed estimates of stock biomass suggest a recent increase in stock size, noting that most of that increase can be attributed to biomass located in the northern component of the stock.
...
```{r strata-map, eval = T, echo = FALSE, fig.cap= "Strata map for the northern component of the monkfish (*Lophius americanus*) stock on the NE shelf", message = FALSE, warning = FALSE, fig.align='center'}
...
An optimal interpolation procedure was used to estimate NE Shelf surface and bottom temperatures for two seasonal time frames (see [methods](#methodstempsalin)). The temperature estimates were standardized to April 3 and October 11 for spring and fall over the period 1968-2018. Surface and bottom temperature within the monkfish stock areas are shown below.


## Bottom Temperature {-#bottom-temperature}


Thermal conditions on the Northeast Shelf have changed in recent decades as reflected in changes in bottom water temperatures in the stock areas. In both spring and fall, bottom water temperatures have significantly increased.
...
Thermal conditions on the Northeast Shelf have changed in recent decades as reflected in changes in surface water temperatures in the stock areas. In both spring and fall, bottom water temperatures have significantly increased. There is evidence of step changes in surface temperature in 2010.
...
An optimal interpolation procedure was used to estimate NE Shelf surface and bottom salinity for two seasonal time frames (see methods). Though collected with temperature data, reliable instrumentation limits this time series to 1992-2018. The salinity estimates were standardized to April 3 and October 11 for spring and fall. Surface and bottom salinities within the monkfish stock areas are shown below.


## Bottom Salinity {-#bottom-salinity}


Bottom salinity shows a significant increasing trend in both the spring and fall, with an increased salinity regime in 1999 and 2011. 
...
Surface salinity showed no significant trends in the spring, but in the fall there was a significant trend and evidence of several changing regimes with step increases in 1999 and 2011.
...
Chlorophyll concentration in the spring showed no significant linear trend but there appears to be evidence of a regime change to a lower level of chlorophyll in 2013. In the fall, there is a significant decreasing linear trend with a lower concentration regime beginning in 2013.


## Chlorophyll concentration in the stock area {-#chlorophyll-concentration-in-the-stock-area}


The concentration of chlorophyll was measured with a suite of satellite sensors and merged into a single dataset (see [methods](#methodschl)). Chlorophyll concentrations in the spring and fall monkfish stock areas are shown below. Spring chlorophyll concentration varies without trend, but may change to a lower level of chlorophyll concentration in 2013. In the fall, there is a significant decreasing linear trend with a lower concentration regime beginning in 2013.
...
Zooplankton are an important component of larval monkfish diet. Pelagic young-of-the-year monkfish consume chaetognaths, hyperiid amphipods, calanoid copepods, and ostracods (@able2007transitions). Since spawning activity progresses northward from spring to fall (@mcbride2017goosefish), fall zooplankton indices (Sep-Nov) are likely more relevant than the spring indices with regard to larval food availability for northern monkfish, particularly since the larval period for monkfish occurs in the summer months (@walsh2015long). Although fall copepod time-series are highly variable, there appears to be a protracted decline in *Pseudocalanus* spp., which coincide with recent increases in *Calanus finmarchicus*, *Centropages typicus*, and *Olthona* spp..  In the fall, many of the non-copepod zooplankton show recent increasing trends and may be more available to pelagic larval monkfish.
...
The probability of occurrence was estimated using random forest classification models (see [methods](#methodsocc)). The mean annual probabilities were extracted for the spring and fall stock definition areas. These data provide an estimate of the potential use of the habitat associated with the stock definition. Both spring and fall occupancy has increased from 0.4 to greater than 0.5 over the time series and is currently near the time series maximum.
...
The area of the Northeast shelf with an estimated occurrence probability of ~0.60 for the northern component of the monkfish stock was determined for the stock area and the ecosystem.
...
Both the spring and fall component of the northern monkfish stock habitat area have increased from less than 20000 km^2^ and 1000 km^2^ in the 1970s to a high of ~ 50000km^2^ in the recent decade.
...
Estimates of the biomass for the minimum population size of monkfish was determined by re-stratifying the habitat each year depending on the distribution of occupancy habitat (see [methods](#methodsocc)). The procedure provides eight population size estimates for each stock, by season, based on the use of three estimation options. The estimates are denoted by a three-letter code (Y/N|Y/N|Y/N) where the first position indicates whether data were interpolated over habitat strata. The second position indicates whether the trawl data applied to the estimate was limited to the stations made in the stock area only or if trawls from other areas were used as well. The third position indicates whether the trawl data were subjected to a test for outliers, in which outliers were eliminated. Of the eight treatment options, the biomass estimates for spring and fall were based on the NNN and YYN options, respectively. Over most of the time series, the spring minimum population biomass averaged approximately 5 million kg; however, during the most recent decade, the biomass declined to nearly half that level. The stock appears to be on an upward trajectory with increase stock size through 2018. The fall biomass is similarly patterned with a long-term average of approximately 5 million kg and a decline in the most recent decade. However, the fall 2018 biomass estimate appears to be markedly less than that spring estimate. 
