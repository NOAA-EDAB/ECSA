...
stock_code <- "105"
stock_name <- "yellowtail-flounder_sne-ma"
cc_name <- "yellowtail-flounder"
common_name <- "yellowtail flounder"
...
if (grepl("north", stock_name)){
  map_lab <- paste0('Strata map for the northern component of the yellowtail flounder (', ifelse(knitr::is_latex_output(), '\\textit{Limanda ferruginea}','*Limanda ferruginea*'),') stock on the NE shelf.')
} else if (grepl("south", stock_name)){
  map_lab <- paste0('Strata map for the southern component of the yellowtail flounder (', ifelse(knitr::is_latex_output(), '\\textit{Limanda ferruginea}','*Limanda ferruginea*'),') stock on the NE shelf.')
} else {
  map_lab <- "Strata map for the yellowtail flounder (Limanda ferruginea) stock on the NE shelf."
}
