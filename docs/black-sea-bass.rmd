...
if (grepl("north", stock_name)){
  map_lab <- paste0('Strata map for the northern component of the black sea bass (', ifelse(knitr::is_latex_output(), '\\textit{Centropristis striata}','*Centropristis striata*'),') stock on the NE shelf.')
} else if (grepl("south", stock_name)){
  map_lab <- paste0('Strata map for the southern component of the black sea bass (', ifelse(knitr::is_latex_output(), '\\textit{Centropristis striata}','*Centropristis striata*'),') stock on the NE shelf.')
} else {
  map_lab <- "Strata map for the black sea bass (Centropristis striata) stock on the NE shelf."
}
