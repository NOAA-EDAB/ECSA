...
```{r strata-map, eval = T, echo = FALSE, fig.cap= paste0("Strata map for black sea bass (",ifelse(knitr::is_latex_output(), '\\textit{Centropristis striata}','*Centropristis striata*'),") on the NE shelf"), message = FALSE, warning = FALSE, fig.align='center'}
