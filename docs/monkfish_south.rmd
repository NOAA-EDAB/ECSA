...
```{r strata-map, eval = T, echo = FALSE, fig.cap= paste0("Strata map for the southern component of the monkfish (",ifelse(knitr::is_latex_output(), '\\textit{Lophius americanus}','*Lophius americanus*'),") stock on the NE shelf"), message = FALSE, warning = FALSE, fig.align='center'}
