...
title: |
  ...
  | Southern component of monkfish stock
author: ''
...
```{r strata-map, eval = T, echo = FALSE, fig.cap= "Strata map for monkfish (*Lophius americanus*) on the NE shelf", message = FALSE, warning = FALSE, fig.align='center'}
...
Thermal conditions on the Northeast Shelf have changed in recent decades as reflected in changes in bottom water temperatures in the stock areas. In both spring and fall, bottom water temperatures have significantly increased. There is evidence of a cyclican step change in spring bottom temperature early in the time series and a step change in fall bottom temperature in 2008.
...
The spring surface temperature has varied without trend throughout the time series. The fall surface temperature has a significant positive trend and there is evidence of a step change in 2009.
...
Bottom salinity shows a significant increasing trend in the spring. There is evidence of an increased salinity regime beginning in the spring in 2000.
...
Both spring and fall surface salinity increased over the time series. Similar to bottom salinity, spring surface salinity increased over time with a change point increase in salinity in 2000.
...
The concentration of chlorophyll was measured with a suite of satellite sensors and merged into a single dataset (see [methods](#methodschl)). Chlorophyll concentrations in the spring and fall monkfish stock areas are shown below. Both spring and fall chlorophyll concentrations vary without trend, but may change to a lower level of chlorophyll concentration in 2015 and 2013.
...
Zooplankton are an important component of larval monkfish diet. Pelagic young-of-the-year monkfish consume chaetognaths, hyperiid amphipods, calanoid copepods, and ostracods (@able2007transitions). Since spawning activity progresses northward from spring to fall (@mcbride2017goosefish), spring zooplankton indices are likely more relevant than the fall indices with regard to larval food availability for southern monkfish, particularly since the larval period for monkfish occurs in the summer months (@walsh2015long). Although spring copepod time-series are highly variable, there appears to be a protracted decline in *Pseudocalanus* spp., which coincide with recent increases in *Calanus finmarchicus*, *Centropages typicus*, and *Olthona* spp..  In the spring, many of the non-copepod zooplankton show recent increasing trends and may be more available to pelagic larval monkfish.
...
The area of the Northeast Shelf with an estimated occurrence probability of 0.35 for the southern component of the monkfish stock was determined for the stock area and the ecosystem.
...
The spring component of the southern monkfish stock habitat area has cycled from a high of ~40000 km^2^ in the mid 1970s to a low period ~10000km^2^ in the 1990s and 2000s. Recently, it has increased to ~ 35000 km^2^ over the past decade. 
The fall component of the southern monkfish stock habitat area has increased from ~10000 km^2^ in the 1970s to a high of ~ 30000km^2^ in the recent decade.
...
Estimates of the biomass for the minimum population size of monkfish was determined by re-stratifying the habitat each year depending on the distribution of occupancy habitat (see [methods](#methodsocc)). The procedure provides eight population size estimates for each stock, by season, based on the use of three estimation options. The estimates are denoted by a three-letter code (Y/N|Y/N|Y/N) where the first position indicates whether data were interpolated over habitat strata. The second position indicates whether the trawl data applied to the estimate was limited to the stations made in the stock area only or if trawls from other areas were used as well. The third position indicates whether the trawl data were subjected to a test for outliers, in which outliers were eliminated. Of the eight treatment options, the biomass estimates for spring and fall were based on the NYY and NYN options, respectively. Early in the time series, the minimum stock biomass for the southern stock during spring was approximately 3.5 million kg; however, since the mid-1980s, the stock appears to be have been at approximately half that level. The most recent estimate in the time series suggest an increase in stock biomass through the year 2018. The early portion of the fall time series suggest larger stock biomass levels with minimum sizes in excess of 10 million kg. There is also the suggestion of an increase in stock biomass in the most recent years of the time series; however, the 2017 value may be overly optimistic since it is based on the computational option that include tow data from outside the stock area.
