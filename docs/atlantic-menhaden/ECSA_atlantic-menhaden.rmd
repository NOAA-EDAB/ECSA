...
```{r spring_biomass_plt, fig.height=3, eval = F}
spring_biomass_plt <-  
...
```{r fall_biomass_plt, fig.height=3, eval = F}
fall_biomass_plt <- 
...
## Swept Habitat Area Abundance Estimates {-#swept-habitat-area-abundance-estimates}

=======
>>>>>>> cd918e3ddd48c1ff31435ee8eac1ab7f4c2bc105
```{r sae_processing}
