...
bibliography: ["atlantic-menhaden_bib.bib","`r here::here('ECSA_bibliography.bib')`"]
link-citations: true
...
## Chlorophyll concentration in the stock area
...
knitr::include_graphics(here::here('data/images/ECSA_study_area.jpg'))
```
...
knitr::include_graphics(here::here("data/images/ECSA_occ_grid.png"))
```
...
knitr::include_graphics(here::here("data/images/ECSA_oi_compare.png"))
```
