...
if (grepl("north", stock_name)){
  map_lab <- paste0('Strata map for the northern component of the ocean pout (', ifelse(knitr::is_latex_output(), '\\textit{Zoarces americanus}','*Zoarces americanus*'),') stock on the NE shelf.')
} else if (grepl("south", stock_name)){
  map_lab <- paste0('Strata map for the southern component of the ocean pout (', ifelse(knitr::is_latex_output(), '\\textit{Zoarces americanus}','*Zoarces americanus*'),') stock on the NE shelf.')
} else {
  map_lab <- "Strata map for the ocean pout (Zoarces americanus) stock on the NE shelf."
}
...
This report provides contextual ecosystem information for ocean pout (*Zoarces americanus*) on the Northeast U.S. Continental Shelf. Data extractions for spring and fall are confined to the ocean pout stock area based on respective survey strata sets. The information is intended to span a range of potential factors affecting the productivity and distribution of ocean pout, including: surface and bottom temperature and salinity, chlorophyll concentrations, indices of habitat, diet composition, and abundance of key zooplankton prey of larval ocean pout. These factors can be used to qualitatively inform the interpretation of population status and/or quantitatively to improve model responsiveness to ecosystem factors. The range and complexity of ecosystem data makes it unlikely to find the most relevant and comprehensive factor variables with a first evaluation; this process will require an iterative approach of evaluation and feedback. Additional indices can be included to address the needs of the working group.
