...
stock_code <- "77"
stock_name <- "red-hake_gom-ngb"
cc_name <- "red-hake"
common_name <- "red hake"
...
if (grepl("north", stock_name)){
  map_lab <- paste0('Strata map for the northern component of the red hake (', ifelse(knitr::is_latex_output(), '\\textit{Urophycis chuss}','*Urophycis chuss*'),') stock on the NE shelf.')
} else if (grepl("south", stock_name)){
  map_lab <- paste0('Strata map for the southern component of the red hake (', ifelse(knitr::is_latex_output(), '\\textit{Urophycis chuss}','*Urophycis chuss*'),') stock on the NE shelf.')
} else {
  map_lab <- "Strata map for the red hake (Urophycis chuss) stock on the NE shelf."
}
