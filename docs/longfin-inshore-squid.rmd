...
stock_name <- "longfin-inshore-squid"

cc_name <- "longfin-inshore-squid"

common_name <- "longfin inshore squid"
...
if (grepl("north", stock_name)){
  ...
  map_lab <- paste0('Strata map for the northern component of the longfin inshore squid (', ifelse(knitr::is_latex_output(), '\\textit{Doryteuthis pealeii}','*Doryteuthis pealeii*'),') stock on the NE shelf.')

} else if (grepl("south", stock_name)){

  map_lab <- paste0('Strata map for the southern component of the longfin inshore squid (', ifelse(knitr::is_latex_output(), '\\textit{Doryteuthis pealeii}','*Doryteuthis pealeii*'),') stock on the NE shelf.')

} else {

  map_lab <- "Strata map for the longfin inshore squid (Doryteuthis pealeii) stock on the NE shelf."
...
An optimal interpolation procedure was used to estimate NE Shelf surface and bottom temperatures for two seasonal time frames (see [methods](#methodstempsalin)). The temperature estimates were standardized to April 3 and October 11 for spring and fall over the period 1968-2018. Surface and bottom temperature within the longfin inshore squid stock areas are shown below.
...
An optimal interpolation procedure was used to estimate NE Shelf surface and bottom salinity for two seasonal time frames (see [methods](#methodstempsalin)). Though collected with temperature data, reliable instrumentation limits this time series to 1992-2018. The salinity estimates were standardized to April 3 and October 11 for spring and fall. Surface and bottom salinities within the longfin inshore squid stock areas are shown below.
...
The concentration of chlorophyll was measured with a suite of satellite sensors and merged into a single dataset (see [methods](#methodschl)). Chlorophyll concentrations in the spring and fall longfin inshore squid stock areas are shown below.
