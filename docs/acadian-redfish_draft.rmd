...
stock_code <- "155"
stock_name <- "acadian-redfish"
cc_name <- "acadian-redfish"
common_name <- "Acadian redfish"
...
if (grepl("north", stock_name)){
  map_lab <- paste0('Strata map for the northern component of the Acadian redfish (', ifelse(knitr::is_latex_output(), '\\textit{Sebastes fasciatus}','*Sebastes fasciatus*'),') stock on the NE shelf.')
} else if (grepl("south", stock_name)){
  map_lab <- paste0('Strata map for the southern component of the Acadian redfish (', ifelse(knitr::is_latex_output(), '\\textit{Sebastes fasciatus}','*Sebastes fasciatus*'),') stock on the NE shelf.')
} else {
  map_lab <- "Strata map for the Acadian redfish (Sebastes fasciatus) stock on the NE shelf."
}
