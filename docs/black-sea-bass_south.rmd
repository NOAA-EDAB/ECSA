...
title: |
  ...
  | Southern component of black sea bass stock
author: ''
...
stock_code <- "141"
stock_name <- "black-sea-bass_south"
...
An optimal interpolation procedure was used to estimate NE Shelf surface and bottom temperatures for two seasonal time frames (see [methods](#methodstempsalin)). The temperature estimates were standardized to April 3 and October 11 for spring and fall over the period 1968-2018. Spring surface and bottom temperature within the southern component of the black sea bass stock area are shown below.


## Bottom Temperature {-#bottom-temperature}


Thermal conditions on the Northeast Shelf have changed in recent decades. The bottom temperature in the spring NEFSC survey have increased significantly over time within the geographic area occupied by the southern component of the black sea bass stock. Since black sea bass are found as far south as Florida, this increase in bottom temperature may be beneficial for the species in this region.  Bottom ocean temperature in the fall throughout the Middle Atlantic Bight has significantly warmed by about 2.1 oC (@kleisner2017marine).  Between the periods 1968-1978 and 2001-2012 in the spring, the center of biomass of black sea bass in the Middle Atlantic Bight has significantly shifted to the northeast (@kleisner2016effects), likely tracking the local climate velocity of the region throughout the entire year.  Laboratory studies of adult black sea bass physiology suggests that maximum metabolic performance occurs at a water temperature of 24.4 °C with decreased performance at warmer temperatures (@slesinger2019effect).  Ocean temperature in the U.S. NES is projected to increase above  2-4 °C over the next 80-years in the southern portion of the northern stock’s range (saba2016enhanced).  Therefore,  it is likely black sea bass range will continue to shift poleward as the ocean continues to warm.
...
The spring surface temperature has not shown a significant trend over time, but does show a change point increase starting in 1989.
...
An optimal interpolation procedure was used to estimate NE Shelf surface and bottom salinity for two seasonal time frames (see [methods](#methodstempsalin)). Though collected with temperature data, reliable instrumentation limits this time series to 1992-2018. The salinity estimates were standardized to April 3 and October 11 for spring and fall. Spring surface and bottom salinities within the southern component of the black sea bass stock area are shown below.


## Bottom Salinity {-#bottom-salinity}


Spring bottom salinity has increased over time within the southern component of the black sea bass stock stock area, with a change point increase in salinity in 2000.
...
Similar to bottom salinity, spring surface salinity increased over time within the southern component of the black sea bass stock stock area, with a change point increase in salinity in 2000.
...
The concentration of chlorophyll was measured with a suite of satellite sensors and merged into a single dataset (see [methods](#methodschl)). Spring chlorophyll concentrations in the southern component of the black sea bass stock area are shown below.


## Chlorophyll concentration in the stock area {-#chlorophyll-concentration-in-the-stock-area}


Spring chlorophyll concentration has declined over time within the southern component of the black sea bass stock stock area, with a change point decline in chlorophyll in 2008.
...
The most abundant copepod species in this region are *Calanus finmarchicus*, *Centropages typicus*, *Oithona* spp., and *Pseudocalanus* spp.  While there is significant interannual variability in the abundance of these species, no clear trends have been observed over multiple decades.
...
The probability of occurrence was estimated using random forest classification models (see [methods](#methodsocc)). The mean annual probabilities were extracted for the spring stock definition area. These data provide an estimate of the potential use of the habitat associated with the southern component of the black sea bass stock definition.
...
The area of the Northeast Shelf with an estimated occurrence probability of 0.25 for the southern component of the black sea bass stock was determined for the stock area and the ecosystem. 
...
The area of habitat has increased significantly over time for the southern component of the black sea bass stock area, and has ranged from 5,000-13,000 km^2^, with a change point of increased habitat area in 1999.
...
Estimates of the biomass for the minimum population size of the southern component of the black sea bass stock were determined by re-stratifying the habitat each year depending on the distribution of occupancy habitat (see [methods](#methodsocc for details)). The procedure provides eight population size estimates for each stock, by season, based on the use of three estimation options.
...
The spring minimum population biomass for the southern component of the black sea bass stock has fluctuated without trend.
