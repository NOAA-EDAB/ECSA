...
```{r strata-map, eval = T, echo = FALSE, fig.cap= paste0("Strata map for scup (",ifelse(knitr::is_latex_output(), '\\textit{Stenotomus chrysops}','*Stenotomus chrysops*'),") on the NE shelf"), message = FALSE, warning = FALSE, fig.align='center'}
