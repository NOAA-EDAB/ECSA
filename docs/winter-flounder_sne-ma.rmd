...
stock_code <- "106"
stock_name <- "winter-flounder_sne-ma"
cc_name <- "winter-flounder"
...
if (grepl("north", stock_name)){
  map_lab <- paste0('Strata map for the northern component of the winter flounder (', ifelse(knitr::is_latex_output(), '\\textit{Pseudopleuronectes americanus}','*Pseudopleuronectes americanus*'),') stock on the NE shelf.')
} else if (grepl("south", stock_name)){
  map_lab <- paste0('Strata map for the southern component of the winter flounder (', ifelse(knitr::is_latex_output(), '\\textit{Pseudopleuronectes americanus}','*Pseudopleuronectes americanus*'),') stock on the NE shelf.')
} else {
  map_lab <- "Strata map for the winter flounder (Pseudopleuronectes americanus) stock on the NE shelf."
}
...
This report provides contextual ecosystem information for southern New England/mid-Atlantic winter flounder (*Pseudopleuronectes americanus*) on the Northeast U.S. Continental Shelf. Data extractions for spring and fall are confined to the winter flounder stock area based on respective survey strata sets. The information is intended to span a range of potential factors affecting the productivity and distribution of winter flounder, including: surface and bottom temperature and salinity, chlorophyll concentrations, indices of habitat, diet composition, and abundance of key zooplankton prey of larval winter flounder. These factors can be used to qualitatively inform the interpretation of population status and/or quantitatively to improve model responsiveness to ecosystem factors. The range and complexity of ecosystem data makes it unlikely to find the most relevant and comprehensive factor variables with a first evaluation; this process will require an iterative approach of evaluation and feedback. Additional indices can be included to address the needs of the working group. Time series data used to create this report can be found [at this link](url).
