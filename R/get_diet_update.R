...
#                                                  stratum_area)]
  ...
  master_munfish_strat_ply <- musw_strat %>% 
...
six_ply <- new4_strat_ply %>% 
  ...
  select(-tt, -vard, -varf, -var_cov, -stratum_area)
