...
Probability of occurrence of summer flounder in NEFSC bottom trawl tows was estimated in each season and year using a logistic regression, i.e., a GLM with a bionomial response and log-odds link (code: https://github.com/NOAA-EDAB/ECSA/blob/master/R/prob_occurence.R. Error bars represent the 95% confidence intervals.
