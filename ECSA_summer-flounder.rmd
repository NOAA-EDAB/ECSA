...
### Strata definition
```{r strata-map, eval = TRUE, echo = FALSE, fig.cap=  for summer flounder (*Paralichthys dentatus*) on the NE shelf", message = FALSE, warning = FALSE, fig.align='center'}
...
### Figures
```{r diet, eval=T, echo = FALSE, fig.align='center', warning = F, fig.cap = "Seasonal weighted diet composition for major summer flounder prey (1977-2016)."}
