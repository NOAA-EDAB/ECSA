...
### Figures
```{r chl fig, echo = F, fig.align="center", fig.height=3}
...
### Figures
```{r trawl-habitat, echo = FALSE, fig.align='center', fig.height=3}
...
oh_plt <- ggplot(data = hab, aes(x = Time, y = Value)) +
  ylab(expression(paste("Occupancy Habitat km"^"-2"))) +
  xlab("Year") +
  xlim(xmin, NA) +
  geom_line() +
  geom_point() +
...
grid.arrange(op_plt, oh_plt, nrow = 2)
occ <- rbind(prob, hab)
```
...
```{r occ_grid, fig.align="center", fig.cap = "Estimation grid for predictor variable and habitat estimates, grid location spaced by 0.1° longitude and latitude.", echo = F, out.width = '500'}
