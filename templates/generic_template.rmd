...
spring_sae <- readr::read_csv(here::here("data-raw/spring_sae_tb_sum.csv"))
fall_sae <- readr::read_csv(here::here("data-raw/fall_sae_tb_sum.csv"))
...
buttons[[2]]$args[[1]]$visible <- c(F, F,F,T,T,rep(F,28))
buttons[[3]]$args[[1]]$visible <- c(F, F,F,F,F,T,T,rep(F,26))
...
colnames(spring_cope)[2]
spring_zoo_1yr_plt
```


```{r zoo_1yr_fall, fig.height=5}
...
buttons <- create_buttons(fall_zoo_1yr_cope)
# 
fall_zoo_1yr_plt <-
  tab_plotly(fall_zoo_1yr_cope, add_smoother = T) %>% 
...
```{r zoo_1yr_spring_noncope, fig.height=5}
...
buttons <- create_buttons(spring_zoo_1yr_noncope)
# 
spring_zoo_1yr_noncope_plt <-
  tab_plotly(spring_zoo_1yr_noncope) %>% 
...
```{r zoo_1yr_fall_noncope, fig.height=5}
...
buttons <- create_buttons(fall_zoo_1yr_noncope)
# 
fall_zoo_1yr_noncope_plt <-
  tab_plotly(fall_zoo_1yr_noncope) %>% 
...
buttons <- create_buttons(spring_zoo_5yr_cope)
# 
spring_zoo_5yr_plt <-
  tab_plotly(spring_zoo_5yr_cope) %>% 
  layout(title = "Spring copepod abundance",
         yaxis = list(title = "Abundance (log num m<sup>-3</sup>)",
                      hoverformat = '.3f'),
         showlegend = F,
...
buttons <- create_buttons(fall_zoo_5yr_cope)
# 
fall_zoo_5yr_plt <-
  tab_plotly(fall_zoo_5yr_cope) %>% 
  layout(title = "Fall copepod abundance",
         yaxis = list(title = "Abundance (log num m<sup>-3</sup>)",
                      hoverformat = '.3f'),
         showlegend = F,
...
```{r zoo_5yr_spring_noncope, fig.height=5}
...
buttons <- create_buttons(spring_zoo_5yr_noncope)
# 
spring_zoo_5yr_noncope_plt <-
  tab_plotly(spring_zoo_5yr_noncope) %>% 
  layout(title = "Spring non-copepod zoo. abundance",
         yaxis = list(title = "Abundance (log num m<sup>-3</sup>)",
                      hoverformat = '.3f'),
         showlegend = F,
...
```{r zoo_5yr_fall_noncope, fig.height=5}
...
buttons <- create_buttons(fall_zoo_5yr_noncope)
# 
fall_zoo_5yr_noncope_plt <-
  tab_plotly(fall_zoo_5yr_noncope) %>% 
  layout(title = "Fall non-copepod zoo. abundance",
         yaxis = list(title = "Abundance (log num m<sup>-3</sup>)",
                      hoverformat = '.3f'),
         showlegend = F,
