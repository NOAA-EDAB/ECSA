...
spring_min <- min(spring_bottom_temp$df$Time)
...
fall_bottom_temp <- 
  fit_regime_and_trend(r = "bot_temp_fall_spdf.rdata",
                ...
                data_season = "fall",
                measure_name = "bottom_temp")
fall_min <- min(fall_bottom_temp$df$Time)
...
spring_min <- min(spring_surface_temp$df$Time)
...
spring_min <- min(spring_bottom_sal$df$Time)
...
fall_bottom_sal <- 
  fit_regime_and_trend(r = "bot_sal_fall_spdf.rdata",
                ...
                data_season = "fall",
                measure_name = "bottom_sal")
fall_min <- min(fall_bottom_sal$df$Time)
...
spring_min <- min(spring_surface_sal$df$Time)
...
fall_surface_sal <- 
  fit_regime_and_trend(r = "surf_sal_fall_spdf.rdata",
                ...
                data_season = "fall",
                measure_name = "surface_sal")
fall_min <- min(fall_surface_sal$df$Time)
...
spring_min <- min(spring_chl$df$Time)
...
spring_stock_area_plt <- ggplot(data = spring_stock_area_df,
  ...
  geom_line()+
  {if(interactive) geom_point_interactive(size = 0)
    else geom_point(data = spring_stock_area_df[spring_stock_area_df$Var == "Series",],aes(color = Var))} +
    scale_color_manual(values = 
                         c("Regime mean" = "#b2df8a",
                         "Trend" = "#a6cee3",
                         "Series" = "#1f78b4"))+
...
fall_stock_area_plt <- ggplot(data = fall_stock_area_df,
  ...
  geom_line()+
  {if(interactive) geom_point_interactive(size = 0)
    else geom_point(data = fall_stock_area_df[fall_stock_area_df$Var == "Series",],aes(color = Var))} +
    scale_color_manual(values = 
                         c("Regime mean" = "#b2df8a",
                         "Trend" = "#a6cee3",
                         "Series" = "#1f78b4"))+
...
```{r ecosystem_hab_area_fall, fig.height=4, eval = T}
...
```{r ecosystem_hab_area_spring, fig.height=4, eval = T}
...
### Spring ecosystem area {-#spring-ecosystem-area}
...
spring_ecosystem_area_plt <- 
  ggplot(data = spring_ecosystem_area_df, 
   ...
   {if(interactive) geom_point_interactive(aes(tooltip = tooltip, data_id = Time,
                                               color = Var))
     else geom_point(data = spring_ecosystem_area_df[spring_ecosystem_area_df$Var == "Series",],aes(color = Var)) } +
        scale_color_manual(values = 
                           c("Regime mean" = "#b2df8a",
                           "Trend" = "#a6cee3",
                           "Series" = "#1f78b4"))+
...
### Fall ecosystem area {-#Fall-ecosystem-area}
...
fall_ecosystem_area_plt <- 
  ggplot(data = fall_ecosystem_area_df, 
   ...
   {if(interactive) geom_point_interactive(aes(tooltip = tooltip, data_id = Time,
                                               color = Var))
     else geom_point(data = fall_ecosystem_area_df[fall_ecosystem_area_df$Var == "Series",],aes(color = Var)) } +
        scale_color_manual(values = 
                           c("Regime mean" = "#b2df8a",
                           "Trend" = "#a6cee3",
                           "Series" = "#1f78b4"))+
