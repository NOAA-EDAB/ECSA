...
biomass_plt <- spring_sae_processed %>% 
    ...
    ggplot() +
     geom_line(aes(x = Time, y = total_log10, color = Treatment)) +
     geom_point(aes(x = Time, y = total_log10, color = Treatment)) +
...
biomass_plt <- spring_sae_processed %>% 
    filter(biomass == "Biomass") %>% 
    ggplot() +
     geom_line(aes(x = Time, y = total, color = Treatment)) +
     geom_point(aes(x = Time, y = total, color = Treatment)) +
     geom_ribbon(aes(x = Time, ymax = upperci, ymin = lowerci, fill = Treatment), alpha = 0.1) +
     theme_minimal() +
     guides(color = F, fill = F) +
     scale_x_continuous(expand = c(0.01, 0.01)) +
     ylab("Biomass (kg)") +
