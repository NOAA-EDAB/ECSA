...
```{r strata-map, eval = T, echo = FALSE, fig.cap= paste0("Strata map for {{COMMON_NAME}} (",ifelse(knitr::is_latex_output(), '\\textit{{{SCI_NAME}}}','*{{SCI_NAME}}*'),") on the NE shelf"), message = FALSE, warning = FALSE, fig.align='center'}
